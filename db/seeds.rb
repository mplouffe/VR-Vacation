...
packages = Package.create([
              { name: 'Explore Mars',                          category: categories[0],    discounts: [ discounts[0] ],      package_contents: [],               screenshot: 'MarsHeadlineImage.jpg',             description: 'Set foot onto the soil of Mars and discover what mysteries the Maritan surface holds.' },
              { name: 'The Depths of Atlantis',                category: categories[0],    discounts: [],                    package_contents: [],               screenshot: 'AtlantisHeadlineImage.jpg',         description: 'Discover an advanced technological society living in the deepest depths of the ocean.' },
              { name: 'War in Ancient Egypt',                  category: categories[1],    discounts: [],                    package_contents: [],               screenshot: 'EgyptHeadlineImage.jpg',            description: "Become a hero in the Pharoh's army, and earn the blessings of the ancient gods." },
              { name: 'Tropical Paradise',                     category: categories[3],    discounts: [],                    package_contents: [],               screenshot: 'TropicalHeadlineImage.jpg',         description: 'Visit a breath-taking tropical paradise. Discover excitement along sun drenched shores.' },
              { name: 'The Crab Nebula',                       category: categories[0],    discounts: [ discounts[0] ],      package_contents: [],               screenshot: 'CrabNebulaHeadlineImage.jpg',       description: 'Witness the birth and death of solar systems in the awe inspiring Crab Nebula.' },
              { name: 'Sweet Life in Candy Land',              category: categories[4],    discounts: [],                    package_contents: [],               screenshot: 'CandyWorldHeadlineImage.jpg',       description: 'Stay in your Gingerbread B&B while enjoying the smells and tastes of an world made of candy.' },

              { name: 'The World at War',                      category: categories[1],    discounts: [],                    package_contents: [],               screenshot: 'WorldWarHeadlineImage.jpg',         description: 'See the destruction and devistation of World at War, where brave souls fight for the fate of the future.' },
              { name: 'The Steam Revolution',                  category: categories[0],    discounts: [],                    package_contents: [],               screenshot: 'SteampunkHeadlineImage.jpg',        description: 'Experience the alternate history of an technological revoution run on steam.' },
              { name: 'Forest of Fantasy',                     category: categories[0],    discounts: [],                    package_contents: [],               screenshot: 'FantasyForestHeadlineImage.jpg',    description: 'Epic adventure awaits in the fantasy forest, filled with magic and mystery.' },
              { name: 'Haunting Terror',                       category: categories[2],    discounts: [],                    package_contents: [],               screenshot: 'TransylvaniaHeadlineImage.jpg',     description: 'Can you survive the crippling terror of a haunted mansion in the remote mountains of Transylvania?' }])
